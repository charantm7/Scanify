...
export function ItemRow({ item, onEdit, onDelete, onToggle }: ItemRowProps) {
  ...
  return (
    ...
    >
      ...
      <GripVertical
        size={14}
        className="flex-shrink-0 cursor-grab select-none opacity-0 group-hover:opacity-40 transition"
      ...
      {/* Price */}
      <div className="flex-shrink-0 text-right mr-1" style={{ opacity: item.is_available ? 1 : 0.5 }}>
        <span
