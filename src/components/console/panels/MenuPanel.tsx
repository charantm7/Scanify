...
function ItemForm({ initial = EMPTY_ITEM, onSubmit, loading }: ItemFormProps) {
  const [form, setForm] = useState<MenuItem>({ ...EMPTY_ITEM, ...initial });
  const [errors, setErrors] = useState<FormError>({});

  function set(field: keyof MenuItem) {
