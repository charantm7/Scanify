        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {steps.map((step, i) => (
            <div
              ...
              className="reveal bg-theme3 border border-theme rounded-[20px] p-8 relative overflow-hidden transition-all duration-300 hover:-translate-y-1 hover:shadow-[var(--shadow2)]"
