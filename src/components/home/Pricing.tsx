...
const annual: PricingPlan[] = [
  ...
  {
    name: 'Starter',
    tagline: 'Create a professional digital menu',
    price: '7,999',
    save: 'Save ₹1,589',
    period: 'per year',
    featured: false,
    features: [
      'Everything in Basic +',
      'Up to 50 menu items',
      'Up to 30 item images',
      'Custom themes, colors & layouts',
  ...
  {
    name: 'Growth',
    tagline: 'Advanced tools for growing restaurants',
    price: '12,999',
    save: 'Save ₹2,589',
    period: 'per year',
    featured: true,
    features: [
      ...
      'Custom fonts',
      'Multiple menus (Food, Drinks, Specials, etc.)',
      'Custom QR designs',
      'Advanced menu & category management',
  ...
  {
    name: 'Pro',
    tagline: 'Complete control for growing restaurant brands',
    price: '19,999',
    save: 'Save ₹3,989',
    period: 'per year',
    featured: false,
    features: [
      ...
      'Peak-hour scan insights',
      'Staff accounts & permissions',
      'Customer engagement insights',
      'Custom subdomain (yourhotel.scanify.co.in)',
      'Full theme & layout customization',
